...
void polygonInner::setPoint(QVector<QPoint> points)
{
    this->points=points;
}

void polygonInner::showPolygonInEdgeTable()
{
...
void polygonInner::Sleep(int msec)
{
